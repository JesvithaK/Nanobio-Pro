...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 text-slate-200 relative overflow-hidden font-sans">
      {/* AMBIENT BACKGROUND */}
      <div className="absolute inset-0 z-0 pointer-events-none opacity-20 bg-size-[4rem_4rem] bg-[linear-gradient(to_right,#1e293b_1px,transparent_1px),linear-gradient(to_bottom,#1e293b_1px,transparent_1px)]" />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[10px] font-mono text-slate-500 mt-2 uppercase tracking-widest">
            Join the Nanobio Pro Research Matrix
          </p>
        </div>
        ...
        <div className="backdrop-blur-xl bg-slate-900/50 border border-slate-800 rounded-2xl p-8 shadow-2xl">
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-mono text-slate-400 uppercase tracking-widest ml-1">Full Name</label>
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-slate-950/50 border border-slate-800 rounded-xl py-3 pl-10 pr-4 text-sm focus:outline-none focus:border-purple-500/50 transition-all placeholder:text-slate-700"
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-mono text-slate-400 uppercase tracking-widest ml-1">Password</label>
              <div className="relative group">
            ...
            <button 
              disabled={isLoading}
              className="w-full py-3 mt-4 bg-purple-600 hover:bg-purple-500 text-white rounded-xl font-bold text-sm transition-all shadow-[0_0_20px_rgba(168,85,247,0.3)] active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-2 uppercase tracking-widest"
            >
              {isLoading ? "Joining Matrix..." : "Sign Up"}
          ...
          <div className="mt-6 text-center">
            ...
            >
              Have an account? <span className="text-purple-400">Login</span>
            </button>
          </div>
        </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-6 text-[10px] font-mono text-slate-600 uppercase">
          ...
          <div className="flex items-center gap-1"><Lock size={12}/> Secure Sync</div>
        </div>
      </motion.div>
    </div>
  );
